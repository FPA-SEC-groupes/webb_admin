...
import Zone from "./components/Dashboard/Restaurant/Zone";
import CategoryPage from "./components/Dashboard/Restaurant/categories";
...
const Markup = () => {
  ...
  const allroutes = [
    ...
    {url: "usertable", component: <UserTable /> },
